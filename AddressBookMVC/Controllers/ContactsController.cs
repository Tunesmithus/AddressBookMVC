...
namespace AddressBookMVC.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Address1,Address2,State,ZipCode,Email,PhoneNumber,Created,ImageType, ImageFile,ImageData")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Address1,Address2,State,ZipCode,Email,PhoneNumber,Created,ImageType,ImageData")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
